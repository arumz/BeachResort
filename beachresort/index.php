...
include ABSOLUTE_PATH . '_includes/header.inc.php';
 ...
 ?>
			<div id="contents">
				<div id="adbox">
					<img src="<?php echo URL_ROOT . 'images/sea-sound.jpg' ?>" alt="Img">
					...
					<div class="box">
						<div>
							<div>
								...
								<ul>
									<li>
										<h4><a href="<?php echo URL_ROOT . 'news.php' ?>">2023 Bikini Contest Winners</a></h4>
									...
									<li>
										<h4><a href="<?php echo URL_ROOT . 'news.php' ?>">Top 10 Diving Spots</a></h4>
				...
				<div id="sidebar">
					<div class="section">
						<a href="<?php echo URL_ROOT . 'rooms.php' ?>"><img src="<?php echo URL_ROOT . 'images/rooms.png' ?>" alt="Img"></a>
					</div>
					<div class="section">
						<a href="<?php echo URL_ROOT . 'dives.php' ?>"><img src="<?php echo URL_ROOT . 'images/dive-site.png' ?>" alt="Img"></a>
					</div>
					<div class="section">
						<a href="<?php echo URL_ROOT . 'foods.php' ?>"><img src="<?php echo URL_ROOT . 'images/food.png' ?>" alt="Img"></a>
					</div>
				</div>
			</div>
		</div>
