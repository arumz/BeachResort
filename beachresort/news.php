					...
					<div>
						<div id="news" class="body">
							<div class="sidebar">
								...
								<ul>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">2023 Bikini Contest Winners</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">Top 10 Diving Spots</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">Fishing ban to be implemented this year</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">Lifeguard saves child from drowning</a>
									</li>
								</ul>
								<h3>Vaction Tips</h3>
								<ul>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">What to bring on the beach?</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">Planning Fun Activities</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">Diving Checklist</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">First Aid</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">How to Build a Sand Castle?</a>
									</li>
									<li>
										<a href="<?php echo URL_ROOT . 'news.php' ?>">Tanning Tips</a>
									</li>
								</ul>
							</div>
							<div>
								<h1>News</h1>
								<img src="<?php echo URL_ROOT . 'images/kayak.jpg' ?>" alt="Img">
