				...
				<div class="box">
					<div>
						<div class="body">
							...
							<ul id="sites">
								<li>
									<a href="dives.php"><img src="<?php echo URL_ROOT. 'images/reef1.jpg' ?>" alt="Img"></a>
								...
								<li>
									<a href="dives.php"><img src="<?php echo URL_ROOT. 'images/reef2.jpg' ?>" alt="Img"></a>
								...
								<li>
									<a href="dives.php"><img src="<?php echo URL_ROOT. 'images/reef3.jpg' ?>" alt="Img"></a>
